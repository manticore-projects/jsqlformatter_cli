...
public class ASTVisualizationTest {
  ...
  public void printAsciiAST() throws Exception {
    ...
    System.out.println(JSQLFormatterCLI.formatToTree(sqlString));

    System.out.println(JSQLFormatterCLI.formatToTree(sqlString, "outputFormat=ANSI"));
  ...
  public void testXML() throws Exception {
    ...
    System.out.println(JSQLFormatterCLI.formatToXML(sqlString));
  ...
  public void testGetXPath() throws Exception {
    String sqlString = "select 1 as b, 2, 3 from dual as tablename where a=b and b=c;";
    String xmlStr = JSQLFormatterCLI.formatToXML(sqlString);
    System.out.println(xmlStr);
    System.out.println(FragmentContentHandler.getXPath(xmlStr));
  ...
  public void testXPath() throws Exception {
    ...
    Collection<Column> columns = JSQLFormatterCLI.extract(sqlString, Column.class, "//Column");
    ...
    columns = JSQLFormatterCLI.extract(sqlString, Column.class, "//where/leftExpression/Column");
    for (Column column : columns) {
      System.out.println("Found WHERE column: " + column);
    }

    // return only the C column based on the complete XPath
    columns = JSQLFormatterCLI.extract(sqlString, Column.class,
  ...
  public void testSerialization() throws IOException, ClassNotFoundException {
    ...
    String serializedObjectStr = byteArrayOutputStream.toString(StandardCharsets.ISO_8859_1);
